# Generated by Django 5.1 on 2025-02-13 09:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "full_name",
                    models.CharField(max_length=60, verbose_name="اسم کامل بازیگر"),
                ),
                (
                    "slug",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "english_title",
                    models.CharField(max_length=350, verbose_name="نام انگلیسی"),
                ),
                ...
                (
                    "about_movie",
                    models.CharField(max_length=500, verbose_name="درباره فیلم"),
                ),
                (
                    "thumbnail",
                    models.ImageField(
                        blank=True, null=True, upload_to="image", verbose_name="تصویر"
                    ),
                ),
                (
                    "trailer",
                    models.FileField(
                        ...
                        null=True,
                        upload_to="video",
                        verbose_name="تریلر فیلم",
                    ),
                ),
                (
                    "is_perimium",
                    models.BooleanField(default=False, verbose_name="اشتراکی"),
                ),
                ...
                (
                    ...
                    models.CharField(
                        max_length=80,
                        null=True,
                        verbose_name="لینک دانلود با کیفیت 480",
                    ),
                ),
                (
                    "download_link_720",
                    models.CharField(
                        max_length=80,
                        null=True,
                        verbose_name="لینک دانلود با کیفیت 720",
                    ),
                ),
                (
                    "download_link_1080",
                    models.CharField(
                        max_length=80,
                        null=True,
                        verbose_name="لینک دانلود با کیفیت 1080",
                    ),
                ),
                (
                    "publish",
                ...
                (
                    "actors",
                    models.ManyToManyField(to="movies.actor", verbose_name="بازیگران"),
                ),
                (
                    "genres",
                    models.ManyToManyField(to="movies.genre", verbose_name="ژانر ها"),
                ),
                (
                    "tags",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "episodes_number",
                    models.PositiveIntegerField(default=0, verbose_name="چند قسمت"),
                ),
                (
                    "seasons",
                    models.PositiveIntegerField(default=1, verbose_name="فصل ها"),
                ),
                (
                    "actors",
                    models.ManyToManyField(to="movies.actor", verbose_name="بازیگران"),
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="episodes", to="movies.serieepisode"
                    ),
                ),
            ],
            options={
